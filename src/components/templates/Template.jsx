...
const Template = ({ data = {}, isPrint = false }) => {
  const { billTo = {}, invoice = {}, yourCompany = {}, items = [], taxPercentage = 0, taxAmount = 0, subTotal = 0, grandTotal = 0, notes = '', selectedCurrency } = data;

  return (
    <BaseTemplate data={data} isPrint={isPrint}>
